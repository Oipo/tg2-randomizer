...
In the reverse-engineering-docs I've got various files with my findings thus far. The files there incredibly big and full of addresses for a specific purpose. To save on tokens, only read the files in reverse-engineering-docs/old/ if I explicitly ask you to.
